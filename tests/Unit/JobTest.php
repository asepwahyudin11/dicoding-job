...
class JobTest extends TestCase
{
    ...
    public function testSubmissionSuccess()
    {
        ...
        // $this->assertEquals($isSuccess, $isReady, "Submission success scenario failed, data not found"); //Coming Soon for XHR submission method
    ...
    public function testSubmissionClosed()
    {
        ...
        // $this->assertEquals($isSuccess, true, "Submission closed scenario failed, job can still receive data"); //Coming Soon for XHR submission method
        $this->assertTrue(true);
    }
}
